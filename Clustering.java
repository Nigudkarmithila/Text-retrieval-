...
public class Clustering {
	...
	public void preprocess(String[] docs) {
		...
		//tf-idf counts and term collection
		int docId = 0;
		for (String doc : docs) {
	...
	public void cluster() {
		...
		for (Double item : docList[6].termVec) {
			second.add(item);
		}
		...
		while (stop != 1) {
			...
			// computing the centroid's element at an index by dividing each index by the cluster length
			int fStop = 0;
